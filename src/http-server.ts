...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across ANSSI guidance documents. Covers PGSSI-S, RGS, SecNumCloud, and ANSSI technical recommendations.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'gestion des correctifs', 'sécurité réseau')" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Get a specific ANSSI guidance document by reference (e.g., 'ANSSI-PGSSI-2021', 'ANSSI-SecNumCloud-3.2').",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "ANSSI document reference" },
      },
      required: ["reference"],
    },
  },
  {
    ...
    description:
      "Search ANSSI security advisories and alerts (CERT-FR). Returns advisories with severity, affected products, and CVE references.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'rançongiciel', 'vulnérabilité critique')" },
        severity: {
          type: "string",
  ...
  },
  {
    ...
    description: "Get a specific ANSSI security advisory by reference (e.g., 'ANSSI-ADV-2024-001').",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "ANSSI advisory reference" },
      },
      required: ["reference"],
    },
  },
